...
class IdentityStep1ScanCustomerScreen extends StatefulWidget {
  const IdentityStep1ScanCustomerScreen({super.key});

  @override
  State<IdentityStep1ScanCustomerScreen> createState() => _IdentityStep1ScanCustomerScreenState();
}

class _IdentityStep1ScanCustomerScreenState extends State<IdentityStep1ScanCustomerScreen> {
  File? _idFrontPhoto;
  File? _idBackPhoto;
  File? _userFacePhoto;
          ...
          Expanded(
            child: AppButton(
              ...
              onTap: _isDocReaderInitializing ||
                ...
                scanCustomerStore.setStep1Data(
                  idFrontPhoto: _idFrontPhoto,
                  idBackPhoto: _idBackPhoto,
