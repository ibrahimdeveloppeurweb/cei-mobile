...
class EnrollmentStep7Screen extends StatefulWidget {
  const EnrollmentStep7Screen({super.key});

  @override
  State<EnrollmentStep7Screen> createState() => _EnrollmentStep7ScreenState();
}

class _EnrollmentStep7ScreenState extends State<EnrollmentStep7Screen> {
