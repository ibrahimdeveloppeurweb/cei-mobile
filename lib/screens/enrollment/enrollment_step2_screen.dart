...
class EnrollmentStep2Screen extends StatefulWidget {
  const EnrollmentStep2Screen({super.key});

  @override
  State<EnrollmentStep2Screen> createState() => _EnrollmentStep2ScreenState();
}

class _EnrollmentStep2ScreenState extends State<EnrollmentStep2Screen> {
  File? _idPhoto;
