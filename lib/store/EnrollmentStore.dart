...
part 'EnrollmentStore.g.dart';

class EnrollmentStore = EnrollmentStoreBase with _$EnrollmentStore;

abstract class EnrollmentStoreBase with Store {
  // Step 1: ID Document
  @observable
  File? idFrontPhoto;
  ...
  @observable
  String? enrollmentReferenceNumber;

  @observable
  String enrollmentStatus = 'En attente';
  ...
  bool get hasActiveEnrollment =>
      enrollmentReferenceNumber != null &&
          enrollmentReferenceNumber!.isNotEmpty;
  ...
  Future<void> submitEnrollment() async {
    ...
    try {
      ...
      // Simulate API delay
      final data = await submitEnrollmentApi();
      ...
      enrollmentReferenceNumber = referenceNumber;
  ...
  @action
  Future<void> loadSavedEnrollmentData() async {
  ...
  Future<void> loadEnrollmentStatus() async {
    try {
      ...
      enrollmentReferenceNumber = getStringAsync(AppConstants.enrollmentReferenceNumberKey);

      if (enrollmentReferenceNumber != null && enrollmentReferenceNumber!.isNotEmpty) {
        ...
        // Mock response
        enrollmentStatus = 'En cours de traitement';
